  ...
  return (
    <PageTop backgroundImageUrl={BG_IMAGE}>
      <div className="breadTxt">
        ...
        <p>
          Design is the method of putting form and content together. Design, just as art, <br/> has multiple
          definitions;
          there is no single definition. Design can be art. <br/>Design can be aesthetics. Design is so simple, thats
          why
